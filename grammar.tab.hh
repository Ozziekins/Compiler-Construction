...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOKEN_RANGE = 307,             /* TOKEN_RANGE  */
    TOKEN_LESS = 308,              /* TOKEN_LESS  */
    TOKEN_LEQ = 309,               /* TOKEN_LEQ  */
    TOKEN_GREAT = 310,             /* TOKEN_GREAT  */
    TOKEN_GEQ = 311,               /* TOKEN_GEQ  */
    TOKEN_INCREMENT = 312,         /* TOKEN_INCREMENT  */
    TOKEN_READINT = 313,           /* TOKEN_READINT  */
    TOKEN_READREAL = 314,          /* TOKEN_READREAL  */
    TOKEN_READSTRING = 315         /* TOKEN_READSTRING  */
  };
